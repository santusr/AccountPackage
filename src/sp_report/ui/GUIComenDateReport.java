...
import sp_report.reg.SERSPReportAsAtDate;

/**
 *
 * @author dell
 */
public class GUIComenDateReport extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUIAccountBalance
     */
    public GUIComenDateReport() {
        initComponents();
    }

    public GUIComenDateReport(String rep, String Title) {
        this();
        this.rep = rep;
        this.Title = Title;
        this.setTitle(title);
    ...
    private void viewReport() {
        SERSPReportAsAtDate report;
        try {
            report = new SERSPReportAsAtDate(Locals.setDateFormat(txtFDate.getDate()), rep, Title);
            report.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            Logger.getLogger(GUIComenDateReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(txtFDate, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(66, 66, 66))
        );
