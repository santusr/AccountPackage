...
import sp_report.reg.SERSPCustomerOnlyReport;
 ...
 * @author dell
 */
public class GUICustomerOnlyReport extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUIAccountBalance
     */
    public GUICustomerOnlyReport() {
        initComponents();
    }

    public GUICustomerOnlyReport(String rep, String Title) {
        this();
        this.rep = rep;
        this.Title = Title;
        this.setTitle(title);
    ...
    private void viewReport() {
        SERSPCustomerOnlyReport report;
        try {
            report = new SERSPCustomerOnlyReport(txtCustomer.getText(), rep, Title);
            report.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            Logger.getLogger(GUICustomerOnlyReport.class.getName()).log(Level.SEVERE, null, ex);
        }
