...
import sp_report.reg.SERSPCustomerReport;

/**
 *
 * @author dell
 */
public class GUICustomerReport extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUIAccountBalance
     */
    public GUICustomerReport() {
        initComponents();
    }

    public GUICustomerReport(String rep, String Title) {
        this();
        this.rep = rep;
        this.Title = Title;
        this.setTitle(title);
    ...
    private void viewReport() {
        SERSPCustomerReport report;
        try {
            report = new SERSPCustomerReport(txtCustomer.getText(), Locals.setDateFormat(txtFDate.getDate()), Locals.setDateFormat(txtToDate.getDate()), rep, Title);
            report.setVisible(true);
            this.dispose();
        } catch (Exception ex) {
            Logger.getLogger(GUICustomerReport.class.getName()).log(Level.SEVERE, null, ex);
        }

    }

    private void loadCus() {
        txtCustomer.setText(SERCommen.getDescription("customer", txtAccCode.getText(), "CustCode", "AccCode"));
        txtCustName.setText(SERCommen.getDescription("customer", txtAccCode.getText(), "CustCode", "PrintName"));
    }
    ...
    private void initComponents() {
        ...
        txtAccCode.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        txtAccCode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtAccCodeActionPerformed(evt);
            }
        });
        jLayeredPane3.add(txtAccCode);
        txtAccCode.setBounds(240, 0, 60, 20);
        ...
        txtCustName.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jLayeredPane3.add(txtCustName);
        txtCustName.setBounds(95, 0, 140, 18);

        txtCustomer.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jLayeredPane3.add(txtCustomer);
        txtCustomer.setBounds(0, 0, 70, 20);
    ...
    private void txtAccCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAccCodeActionPerformed
        loadCus();
    }//GEN-LAST:event_txtAccCodeActionPerformed
