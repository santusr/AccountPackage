...
public class DAOFindWindow {
    ...
    static ArrayList<OBJFindWindow> getDataWithCustomeQuery(Connection conn, String table, String code, String name, String customeWhere) throws SQLException {
        String sql = "SELECT " + code + ", " + name + " FROM " + table + " WHERE Status = '0' " + customeWhere + " ORDER BY " + code + "";
        PreparedStatement st = conn.prepareStatement(sql);
        st.execute();
        ResultSet result = st.getResultSet();
