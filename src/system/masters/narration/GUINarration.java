 ...
 * GUINarration.java
 *
 * Created on Jul 18, 2013, 3:15:47 PM
 */
 ...
 * @author dell
 */
public class GUINarration extends javax.swing.JInternalFrame {

    /** Creates new form GUINarration */
    public GUINarration() {
        initComponents();
        initOthers();
    }
    ...
    private void doDelete() {
        ...
        indexCount = SERNarration.getIndex();
        if (Index < indexCount) {
            getNavi();
        } else {
            Index--;
    ...
    private void getNavi() {
        obj = SERNarration.getNavi(Index);
        txtCode.setText(obj.getCode());
        txtName.setText(obj.getName());
    }

    private void doFind() {
        new GUIFindWindow(null, true, "narration", "Narrationcode", "Narration").setVisible(true);
    ...
    private void serch(String code) {
        obj = SERNarration.serch(code);
        txtCode.setText(obj.getCode());
        txtName.setText(obj.getName());
    }

    private void setID() {
        txtCode.setText(SERNarration.getID());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Narration Code");
