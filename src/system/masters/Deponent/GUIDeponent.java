 ...
 * @author dell
 */
public class GUIDeponent extends javax.swing.JInternalFrame {
    ...
    private void doDelete() {
        ...
        indexCount = SERDeponent.getIndex();
        if (Index < indexCount) {
            getNavi();
        } else {
            Index--;
    ...
    private void serch(String code) {
        obj = SERDeponent.serch(code);
        setContent(obj);
//        txtCode.setText(obj.getCode());
//        txtName.setText(obj.getName());
//        txtAreaCode.setText(obj.getArea());
//        txtArea.setText(SERDeponent.setName(obj.getArea(), "Area", "AreaCode"));
...
//        txtTargt.setText(obj.getTarget());
    ...
    private void setContent(OBJDeponent obj){
        txtCode.setText(obj.getCode());
    ...
    private void setID() {
        txtCode.setText(SERDeponent.getID());
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Deponent Creation");

        jLabel1.setText("Dep. Code");
