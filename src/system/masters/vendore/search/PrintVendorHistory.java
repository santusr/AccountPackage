...
public class PrintVendorHistory extends JFrame {

    public PrintVendorHistory(String CustCode) throws Exception {
    ...
    public PrintVendorHistory(String fileName, String CustCode) {
        super("View Report");
        try {
