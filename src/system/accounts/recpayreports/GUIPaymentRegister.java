...
import core.Exp;
import core.Locals;
import system.inventory.reports.sales.Sales;

/**
 *
 * @author dell
 */
public class GUIPaymentRegister extends javax.swing.JInternalFrame {

    /** Creates new form GUIPaymentRegister */
    public GUIPaymentRegister() {
        initComponents();
    }
    ...
    private void cmdReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdReportActionPerformed
         try {
                    new Sales(Locals.setDateFormat(txtFdate.getDate()), Locals.setDateFormat(txtTodate.getDate()), "REPInstalmentHistory.jasper").setVisible(true);
                    //this.dispose();
                } catch (Exception ex) {
                    Exp.Handle(ex);
                }
