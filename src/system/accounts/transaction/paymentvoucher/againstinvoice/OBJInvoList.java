...
public class OBJInvoList {
    ...
    public OBJInvoList(String InvoNo, String InvoDate, String OriAmount, String OwingAmount, String PaiedAmount, String InvoBalance, String InstallAmount, String PayDate) {
        this.InvoNo = InvoNo;
