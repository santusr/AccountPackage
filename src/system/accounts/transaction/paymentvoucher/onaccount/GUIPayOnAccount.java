 ...
 * GUIOnAccount.java
 *
 * Created on Jul 19, 2013, 5:01:24 PM
 */
 ...
 * @author dell
 */
public class GUIPayOnAccount extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUIOnAccount
     */
    public GUIPayOnAccount() {
        initComponents();
        loadPanel();
    }

    private void doSave() {
        guimultiplidebiting.save();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Payment Voucher (On Account)");
...
private void cmdNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNewActionPerformed
    ...
    private GUIMultipleDebiting guimultiplidebiting;

    private void loadPanel() {
        this.setTitle("Payment Voucher (On Account)");
        guimultiplidebiting = new GUIMultipleDebiting();
        add(guimultiplidebiting, 1);
        setSize(668, 405);
    }
}
