...
public class JournalEntryPanal extends javax.swing.JDialog {
    ...
    private void textFieldManage() {

        if (txtDebitAmount.getText().isEmpty()) {
            txtDebitAmount.setText("0.00");
        }
        if (txtCreditAmount.getText().isEmpty()) {
            txtCreditAmount.setText("0.00");
        }

        double debitAmount = Double.parseDouble(txtDebitAmount.getText());
        ...
        if (debitAmount > 0.00) {
            ...
            txtDebitAmount.setText("0.00");
            txtDebitAmount.setEnabled(false);
        } else {
            txtDebitAmount.setEnabled(!false);
            txtCreditAmount.setEnabled(!false);
        }
    ...
    private void doAdd() {
        if (checkStatus()) {
            ...
            entry.setDebitAmount(txtDebitAmount.getText());
            entry.setCreditAmount(txtCreditAmount.getText());
            System.out.println("Credit Amount : " + txtCreditAmount.getText());
            this.dispose();
        } else {
    ...
    private boolean checkStatus() {
        ...
        double debitAmount = Double.parseDouble(txtDebitAmount.getText());
        double creditAmount = Double.parseDouble(txtCreditAmount.getText());
        if (!txtAccountCode.getText().isEmpty() && !(debitAmount == 0.00 && creditAmount == 0.00) && !(debitAmount < 0.00) && !(creditAmount < 0.00)) {
            b = true;
        }
    ...
    private void initComponents() {
        ...
        txtDebitAmount = new javax.swing.JFormattedTextField();
        txtCreditAmount = new javax.swing.JFormattedTextField();
        ...
        txtDebitAmount.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        txtDebitAmount.setText("0.00");
        txtDebitAmount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDebitAmountActionPerformed(evt);
            }
        });
        txtDebitAmount.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtDebitAmountFocusLost(evt);
            }
        });

        txtCreditAmount.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
        txtCreditAmount.setText("0.00");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtCreditAmount, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 224, Short.MAX_VALUE)
                            .addComponent(txtDebitAmount, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNarration, javax.swing.GroupLayout.Alignment.LEADING)))))
        );
    ...
    private void txtDebitAmountFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDebitAmountFocusLost
        textFieldManage();
    }//GEN-LAST:event_txtDebitAmountFocusLost
    ...
    private void txtNarrationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNarrationActionPerformed
        txtDebitAmount.grabFocus();
    }//GEN-LAST:event_txtNarrationActionPerformed

    private void txtDebitAmountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDebitAmountActionPerformed
        txtCreditAmount.grabFocus();
    }//GEN-LAST:event_txtDebitAmountActionPerformed
    ...
    private javax.swing.JFormattedTextField txtCreditAmount;
    private javax.swing.JFormattedTextField txtDebitAmount;
