...
public class GUIMultipleDebiting extends javax.swing.JPanel {
    ...
    public void save() {
        if (checks()) {
            ...
            voucherOnAccount.setType(TransactionType.RECEIPT);
            ...
            payment.setTransactionType(TransactionType.RECEIPT);
...
//        transHistory();
            ...
            boolean b = SERRecOnAccount.save(voucherOnAccount, cheques, transaction, payment, paymentsInfo, accountTranses, itemTransactions);
            if (b) {
                cheques = null;
                transaction = null;
                payment = null;
    ...
    private boolean checks() {
        return !txtAmount.getText().isEmpty() && !txtCostCenter.getText().isEmpty() && tblCredit.getRowCount() > 0;
    }
    ...
    private boolean accountTransaction() {
        if (paymentsInfo != null) {
            ...
            for (OBJPaymentInfo info : paymentsInfo) {
                ...
                switch (info.getPaymentSetting()) {
                    case PaymentSetting.RECEIPT_CASH:
                        ...
                        System.out.println(((PaymentSettingObject) SystemSetting.getPaymentSeting(PaymentSetting.RECEIPT_CASH)).getCreditOrDebit());
                        System.out.println(((PaymentSettingObject) SystemSetting.getPaymentSeting(PaymentSetting.RECEIPT_CASH)).getAccount());
                        break;
                ...
                accountTrans.setTransactionType(TransactionType.RECEIPT);
            ...
            for (int i = 0; i < tblCredit.getRowCount(); i++) {
                ...
                accountTrans.setCostCode(txtCostCenter.getText());
                accountTrans.setAccountSetting(null);
                accountTrans.setDescription(AccountTransactionDescription.RECEIPT_AMOUNT + "Credit Account : " + tblCredit.getValueAt(i, 1).toString());
                accountTrans.setAccount(tblCredit.getValueAt(i, 1).toString());
                accountTrans.setCreditAmount(tblCredit.getValueAt(i, 3).toString());
    ...
    private boolean getPayment() {
        ...
        new MultiPayOption(null, true, txtAmount.getText(), paymentsInfo, VoucherType.RECEIPT, cheques).setVisible(true);
        if (MultiPayOption.infos != null) {
            ...
            if (cheques != null) {
                ...
                for (OBJCheque oBJCheque : cheques) {
                    ...
                    cheque.setType(TransactionType.RECEIPT);
...
//        buttonMode();
    ...
    private void initComponents() {
        ...
        txtTotalCredit.setBounds(110, 0, 110, 20);
