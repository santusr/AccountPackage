...
public class OBJAgInvo extends OBJVouch {
    ...
    public OBJAgInvo(String CreditId, String InvoNo, String InstallNo, String nxtPDate, String PayAmount, String SPDisc, String Balance, String VouNo, String VouDate, String TransType, String CrAcc, String Naretion, String CostCenter, String PayMod, String PrepBy, String AppBy, String Type, boolean end, String RefNo) {
        super(VouNo, VouDate, TransType, CrAcc, Naretion, CostCenter, PayMod, PrepBy, AppBy, Type, RefNo);
