 ...
 * @author dell
 */
public class GUISalesRegister extends javax.swing.JInternalFrame {

    /**
     * Creates new form GUIPaymentRegister
     */
    public GUISalesRegister() {
        initComponents();
    }
        ...
        if (txtFdate.getDate() != null && txtTodate.getDate() != null) {
            ...
            if (rbtSum.isSelected()) {
               ...
               rep = "REPSalesSrep.jasper"; // Sales Rep Wise
                ...
                try {
                    new Sales(Locals.setDateFormat(txtFdate.getDate()), Locals.setDateFormat(txtTodate.getDate()), rep).setVisible(true);
                    //this.dispose();
                } catch (Exception ex) {
                    Exp.Handle(ex);
                }
