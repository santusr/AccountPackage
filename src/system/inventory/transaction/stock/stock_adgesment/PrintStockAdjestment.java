...
public class PrintStockAdjestment extends JFrame {

    public PrintStockAdjestment(String invNo) throws Exception {
    ...
    public PrintStockAdjestment(String fileName, String invNo) {
        super("View Report");
        try {
