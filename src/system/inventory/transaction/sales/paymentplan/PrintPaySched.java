...
public class PrintPaySched extends JFrame {

    public PrintPaySched(String invNo) throws Exception {

        this(new File(".").getCanonicalPath() + "\\src\\report\\REPPaySchedule.jasper", invNo);
    ...
    public PrintPaySched(String fileName, String invNo) {
        super("View Report");
        try {
