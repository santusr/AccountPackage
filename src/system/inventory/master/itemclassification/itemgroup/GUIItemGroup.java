 ...
 * @author dell
 */
public class GUIItemGroup extends javax.swing.JInternalFrame {
   ...
   initOthers();
    ...
    private void doDelete() {
        ...
        indexCount = SERItemGroup.getIndex();
        if (Index < indexCount) {
            getNavi();
        } else {
            Index--;
    ...
    private void getNavi() {
        obj = SERItemGroup.getNavi(Index);
    ...
    private void doFind() {
        new GUIFindWindow(null, true, "ItemGroup", "GroupCode", "shortName").setVisible(true);
    ...
    private void setID() {
        txtCode.setText(SERItemGroup.getID());
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Item Group File Creation");
