 ...
 * @author dell
 */
public class GUIItemCategory extends javax.swing.JInternalFrame {

    /** Creates new form GUIStore */
    public GUIItemCategory() {
        initComponents();
        initOthers();
    }
    ...
    private void doSave() {
        ...
        if (code.isEmpty() || name.isEmpty()) {
            ...
            int q = JOptionPane.showConfirmDialog(null, "Are you sure want to " + s + " ?", s, JOptionPane.YES_NO_OPTION);
    ...
    private void doDelete() {
        ...
        indexCount = SERItemCategory.getIndex();
        if (Index < indexCount) {
            getNavi();
        } else {
            Index--;
    ...
    private void getNavi() {
        obj = SERItemCategory.getNavi(Index);
        txtCode.setText(obj.getCode());
        txtName.setText(obj.getName());
        txtDesc.setText(obj.getCatname());
    }

    private void doFind() {
        new GUIFindWindow(null, true, "ItemCategory", "CatCode", "shortName").setVisible(true);
        if (accountpackage.AccountPackage.CODE != "") {
    ...
    private void serch(String code) {
        obj = SERItemCategory.serch(code);
        txtCode.setText(obj.getCode());
        txtName.setText(obj.getName());
        txtDesc.setText(obj.getCatname());
    }
    ...
    private void setID() {
        txtCode.setText(SERItemCategory.getID());
    }
    ...
    private void cmdLastActionPerformed(java.awt.event.ActionEvent evt) {
        Index = SERItemCategory.getIndex() - 1;
        getNavi();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Item Category File Creation");

        jLabel1.setText("Cat. Code");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
